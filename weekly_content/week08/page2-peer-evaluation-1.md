...
This prompt asks you to name and reinforce something that is working. Specific recognition is more useful to your teammate than general praise, and it ensures the evaluation isn't exclusively corrective.

**Start:** "What is one specific action this teammate is not currently doing that would help the team if they started?"

This prompt surfaces behavioral gaps without framing them as failures. The framing is forward-looking: what would help if it happened, not what went wrong.
...
*Vague Adjust:* "Sam can be a bit negative sometimes."

*Specific Adjust:* "When the team was deciding how to respond to the employer's scope feedback, Sam said 'that's going to require redoing everything we've done' before we'd actually assessed the impact. That kind of statement shuts down problem-solving. Naming concerns as questions rather than conclusions would help the team work through them more effectively."
...
### Reliability
*Does this teammate do what they say they'll do?*
...
**Evidence prompt:** "Provide a specific example of a commitment this teammate made and how they followed through (or didn't)."
...
### Contribution
*Is this teammate doing their fair share and making the work better?*
...
**Evidence prompt:** "Describe a specific piece of work this teammate produced or a specific way they contributed (or failed to contribute) to the team's progress."
...
*Does this teammate participate in a way that makes the team's work better?*
...
**Evidence prompt:** "Describe a specific instance where this teammate's communication or feedback helped (or hindered) the team's work."
...
### Accountability
*Does this teammate take responsibility for team outcomes, not just their own section?*
...
**Weak evidence:** "They take their individual responsibilities seriously."

**Strong evidence:** "When the team realized the employer's feedback required significant changes to the research section, this teammate immediately proposed a plan for how to divide the revision work and set up a check-in for mid-week to see if anyone was falling behind. They didn't wait for someone else to organize it."
