...
## What goes in the Kickoff Summary

After the kickoff, three things end up in your team's notes: information the employer confirmed directly, things your team is filling in based on context, and things nobody covered. The Summary makes those distinctions explicit so that you know which is which when you go back to the document later.

### Confirmed, assumed, unknown

Before you fill in the Summary, take stock of where your team stands across these three categories:
...
- Open questions are named where they exist, not papered over

Length isn't what's being checked. A short Summary that meets these three standards is enough.
