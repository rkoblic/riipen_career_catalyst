...
## Why both of those start this week

Reflection #5 and the End-of-Project Peer Evaluation are structured to open this week and close next week on purpose. Both are substantial pieces of work, and the reason to begin them now is that neither is the kind of thing that lands well when written in a single sitting at the end.
...
Treat this week's drafting blocks for both as load-bearing, not optional.

---

## Suggested order of completion

1. Read **Planning Your Presentation** first. The planning and Q&A content is what the outline finalization and the deck build are applying.
2. **Finalize and submit the Presentation Outline** before your team starts building the deck. A deliberate outline prevents a thin presentation.
...
5. Read **Transfer + Reflection #5** and begin the reflection draft. Plan this as its own sitting — it is the highest-depth reflection in the portfolio and cramming it into the final week is the failure mode the course is trying to prevent.
6. Read **End-of-Project Peer Evaluation** and begin the instructions review plus evidence gathering. Ratings wait until next week, after the rehearsal and Final Presentation add final evidence.
