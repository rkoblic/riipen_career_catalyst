...
Your goal between now and the check-in: get far enough in your production work that you can identify where you're stuck or uncertain in ways that the employer can help with. That means:

- Draft enough of your section that you know where the real gaps are, not the theoretical ones
- Identify decision points your team hasn't been able to resolve internally
- Formulate questions that are specific enough to get useful answers

Coverage matters here for a practical reason: you can't identify the right questions to ask if you haven't engaged deeply enough with the work to discover what you don't know. A team that hasn't started drafting will show up with generic questions. A team that's been in the work will show up with specific ones.
