...
# End-of-Project Peer Evaluation — Finalize and Submit
...
## What this week added to your evidence base
...
**AI is permitted for organizational work.** Taking your notes on a teammate and asking AI to help sort them by BARS dimension, flag where evidence is thin, or point out inconsistencies between your qualitative feedback and your ratings is fair use. The prompt from last week still works:

> Here are my notes on [teammate] from across the project. Help me sort these into the four BARS dimensions. Flag dimensions where the evidence I have is strong enough to support a specific rating, and dimensions where I need to think more before rating.

**AI cannot generate the evaluation itself.** The observations, ratings, qualitative feedback, contribution allocation, self-evaluation, and closure answers must all reflect your genuine assessment. The learning in this activity happens in the act of evaluating — thinking carefully about what you observed, deciding what it means, and figuring out how to say it usefully. AI-generated evaluations bypass that process, and produce feedback that your teammate cannot act on.

**Disclosure is required on submission.** A one-line statement describing any AI use is sufficient. If AI was not used, a one-line statement to that effect is fine.
...
- Each teammate has three Continue/Start/Adjust responses with specific behavioral references.
- Each teammate has a BARS rating on each of the four dimensions, each with a specific behavioral evidence example.
- The contribution allocation sums to 100 and is unequal.
- The contribution allocation roughly tracks the BARS ratings — if they pull in different directions, one of them needs a second look.
