...
**Disclosure is required on submission.** A one-line statement describing any AI use during drafting or refinement is sufficient. If AI was not used beyond the original prompting work from the course, a one-line statement to that effect is fine.
