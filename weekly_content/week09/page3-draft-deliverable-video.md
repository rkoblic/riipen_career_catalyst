...
# Video Script: Making a team document read as one

Here's what multi-author writing often looks like in practice. A social media strategy team produces a target audience section using "followers" and "users" throughout. A different team member writes the content recommendations section using "community members" for the same group. Neither is wrong. But in the same document, reading them back to back, the inconsistency signals that the document wasn't reviewed as a whole.
