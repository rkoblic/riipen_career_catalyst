# Templates, Downloadable Examples & Resources — To Create

A working list of every learner-facing template, downloadable example, or linked resource still flagged as a placeholder in the weekly content. Sourced from a sweep of `[TEMPLATE: ...]`, `[DOWNLOADABLE: ...]`, `[DOWNLOADABLE EXAMPLE: ...]`, `[LINKED RESOURCE: ...]`, `URL_TBD`, `[PLATFORM: TBD]`, and `[PLACEHOLDER: ...]` markers across `weekly_content/week01/`–`weekly_content/week15/`. (Excludes `.canvas.html`, CHANGELOGs, and `*-content-review.md`.)

---

## A. Templates (learner-facing, fillable)
...
| 7 | **Context Analysis & Project Plan (4-part)** | `weekly_content/week04/page2-context-analysis-and-project-plan.md` | 33 | Org & Project Context, Research Findings, Strategic Implications, Project Plan |
| 8 | **Direction Check Summary** | `weekly_content/week05/page5-direction-check-summary.md` | 55 | 3-section format: feedback received / plan adjustments / confirmed approach (~100 words) |
| 9 | **Change Log** | `weekly_content/week06/page3-revisiting-the-final-deliverable.md` | 53 | Feedback item \| Source \| How addressed (or rationale not to). Needs 2–3 example rows |
| 10 | **Revision Plan** | `weekly_content/week08/page4-acting-on-feedback.md` | 49 | Feedback item \| Source \| Revision required \| Owner \| Target date. Needs 2–3 example rows |
| 11 | **Team Processing Agreement** | `weekly_content/week09/page2-team-processing-session.md` | 134 | Two sections: individual commitments + team commitments from employer feedback |
| 12 | **Presentation Outline** | `weekly_content/week12/page3-presentation-fundamentals.md` | 144 | Key Messages, Narrative Arc, Visual Approach, Speaker Assignments + handoffs |

## B. Downloadable Examples / Reference Cards

| # | Artifact | Page | Line | Brief |
|---|---|---|---|---|
...
Each is a separate document we'd write once and link from every page that points to it.

| # | Artifact | Pages that link to it |
|---|---|---|
...
| # | Artifact | Page | Line |
|---|---|---|---|
| 20 | **Post-course resources doc** (alumni community, LinkedIn recommendation workflow, post-course platform access, follow-on programs) | `weekly_content/week15/page7-closing-the-course.md` | 34 |

---

## Distinct artifacts, deduplicated

**Templates (12):** Deliverable Timeline Table · Weekly Planning Worksheet · Team Charter · Pre-Kickoff Confirmation Message · Post-Kickoff Follow-Up Message · Kickoff Summary · Context Analysis & Project Plan · Direction Check Summary · Change Log · Revision Plan · Team Processing Agreement · Presentation Outline
